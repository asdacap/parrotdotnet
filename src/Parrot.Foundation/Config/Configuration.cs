...
internal sealed partial class Configuration(string path)
{
    ...
    public IPromptTemplateCatalog PromptTemplates { get; private set; } =
        ...
        IReadOnlyDictionary<string, string> environment)
    {
        ...
        var promptTemplates = ReadPromptTemplates(root, static templates => new PromptTemplateCatalog(templates));
    ...
    private static IPromptTemplateCatalog ReadPromptTemplates(
        YamlMappingNode root,
        Func<IReadOnlyDictionary<string, PromptTemplate>, IPromptTemplateCatalog> createCatalog)
    {
        ...
        return createCatalog(templates);
    }
