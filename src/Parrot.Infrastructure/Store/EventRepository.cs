...
internal sealed partial class EventRepository : IEventRepository
{
    ...
    private readonly IAgentHistoryFile? _historyFile;
    private readonly EventRepository? _source;
    private IUserSessionStatistics? _runtimeStatistics;
    ...
    private EventRepository(EventRepository repository, IAgentHistoryFile historyFile)
    {
        _source = repository;
    ...
    public IUserSessionStatistics GetRuntimeStatistics()
    {
        ...
        lock (_database.Gate)
        {
            return _runtimeStatistics ??= new UserSessionStatistics(ReplayStatistics());
        }
    }

    public IEventRepository BindAgentHistory(IAgentHistoryFile historyFile)
    {
    ...
    public SessionUsage? AppendMessage(Event published, LLMMessage? message, ConversationOrigin origin)
    {
    ...
    public Admission Admit(
        ...
        AdmitParts(agentSessionId, messageId, [ConversationPart.TextPart(content)], delivery, compose);

    public Admission AdmitParts(
        string agentSessionId,
        string messageId,
        IReadOnlyList<ConversationPart> parts,
        Delivery delivery,
