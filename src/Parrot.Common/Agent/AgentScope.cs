...
internal sealed class AgentScope
{
    ...
    private AgentScope(ScopeChange[] changes, IPromptTemplateCatalog promptTemplates)
    {
        _changes = changes;
    ...
    public static AgentScope Empty(IPromptTemplateCatalog promptTemplates) => new([], promptTemplates);
