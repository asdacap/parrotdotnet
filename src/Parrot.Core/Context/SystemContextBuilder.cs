...
internal sealed class SystemContextBuilder(string workingDirectory, string date, string sessionContext)
{
    private const string BasePrompt =
        ...
        + "and exec_command only for shell commands. The host filesystem is read-only; the working "
        + "directory and its Git repository root are writable. Prefer small, verifiable steps.";
