...
internal sealed class ProviderSessionsTests
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var firstOwner = new ProviderSessions(TestDiagnosticLog.Instance, "agent-test", null);
        var secondOwner = new ProviderSessions(TestDiagnosticLog.Instance, "agent-test", null);
