...
internal sealed class AgentStatusToolTests : IAsyncDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var tool = new AgentStatusTool(parent.Resolver, parent.ChildRegistry, processes);
