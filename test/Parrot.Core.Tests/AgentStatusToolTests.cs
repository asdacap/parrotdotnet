...
internal sealed class AgentStatusToolTests : IAsyncDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var tool = new AgentStatusTool(parent.ChildRegistry, processes);
        ...
        TimeProvider timeProvider) : IAgentSessionFactory
    {
            ...
            CancellationToken lifetime)
        {
            ...
            return AgentSessionDirectScope.Build(identity, AgentSessionParentScope.Root(), registry, TestModels.PromptTemplates, (children, childQuestions) =>
            {
